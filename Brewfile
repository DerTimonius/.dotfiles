...
brew "jandedobbeleer/oh-my-posh/oh-my-posh", link: false, trusted: true
# A simple terminal UI for docker, written in Go
brew "jesseduffield/lazydocker/lazydocker", trusted: true
# Incredibly fast JavaScript runtime, bundler, transpiler and package manager - all in one.
brew "oven-sh/bun/bun", trusted: true
# Incredibly fast JavaScript runtime, bundler, transpiler and package manager - all in one.
brew "oven-sh/bun/bun@1.2.18", link: false, trusted: true
...
cask "tabularisdb/tabularis/tabularis"
# Live wallpaper app
cask "wallspace"
...
go "github.com/DerTimonius/gdmult"
go "github.com/mauricioabreu/golings/golings"
go "github.com/DerTimonius/hellog"
go "github.com/DerTimonius/twkb"
go "github.com/DerTimonius/zdmult"
