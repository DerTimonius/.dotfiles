...
hl.animation({ leaf = "workspaces", enabled = true, speed = 2.4, bezier = "almostLinear", style = "slide" })
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 2.2, bezier = "almostLinear", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 2.2, bezier = "almostLinear", style = "slide" })
...
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("hyprpicker | wl-copy"), { desc = "Pick color" })
...
hl.bind(ctrlMod .. " + C", hl.dsp.exec_cmd("zeditor"), { desc = "Open Zed" })
...
hl.bind(altMod .. " + 4", hl.dsp.exec_cmd("noctalia msg plugin noctalia/screen_recorder:service all toggle"))
